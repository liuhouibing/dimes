sap.ui.define([
	...
	'sap/m/library',
	"sap/m/MessageToast"
], function (BaseController, JSONModel, formatter, FlaggedType, Filter, FilterOperator, mobileLibrary, MessageToast) {
	"use strict";
	...
	return BaseController.extend("sap.ui.demo.bulletinboard.controller.Worklist", {
		...
		onPostFormSave: function(oEvent) {			
			...
			OdataModel.create("/Posts", oData, {success: function(){
				MessageToast.show("Document has been sucessfully posted");
				this.getView()._oDialog.close();
			}, error: function(){
				MessageToast.show("Document posting failed");
			}});
